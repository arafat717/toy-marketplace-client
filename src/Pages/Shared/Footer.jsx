...
const Footer = () => {
    return (
        <footer className="footer footer-center rounded-xl p-10  bg-gray-900 text-primary-content">
            <div>
                ...
                <p className="font-bold">Providing reliable tech since 1992
                </p>
            ...
            <div>
                ...
                <div>
                    <a className="link m-3 link-hover">About us</a>
                    <a className="link m-3 link-hover">Contact</a>
                    <a className="link m-3 link-hover">Jobs</a>
                    <a className="link m-3 link-hover">Press kit</a>
                </div>
            </div>
        </footer>
    );
